%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%  Tests on the 1D Laplace boundary control problem %%%%%%%%
%%%%%%    results are saved in 'results/pal_test_2.csv   %%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%

clear;
n_samples = 1;
n_array = [101;201;401;801;1601];
...
for n_index=1:n_experiments
    ...
    for k=1:n_samples
        ...
        h = 1/n1;
        Ac = full(gallery('tridiag',n1,-1,2,-1));
        Bc = zeros(n1,1);
        Bc(1) = 1;
        ...
        [Edr,Adr,QQ,ZZ] = hess(Ed,Ad);

        Q = [flip(QQ',2), zeros(n1,n1+1);
            zeros(1,n1),1,zeros(1,n1);
            zeros(n1,n1+1),ZZ];
...
writetable(table(n_array, backward_errors_pal, it_count_pal, swap_count_pal,...
        swap_count_pal_with_reduction, mid_swap_count_pal, refinement_count_pal,...
        backward_errors_palz, it_count_palz, swap_count_palz, mid_swap_count_pal,...
        refinement_count_pal), 'results/pal_test_2.csv')